  ...
  return (
    <div className="w-full lg:px-20 px-5 py-[80px] bg-white flex flex-col justify-center items-center gap-4">
      ...
      <div
        data-aos="zoom-in"
        data-aos-delay="300"
        className="w-full grid lg:grid-cols-6 justify-center items-center gap-6 mt-8"
      >
      ...
      <button
        data-aos="zoom-in"
        data-aos-delay="400"
        className="bg-purple-600 hover:bg-yellow-500 text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-12 uppercase"
      >
        #ElectraShop
      </button>
    </div>
