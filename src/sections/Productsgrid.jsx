...
const Productsgrid = () => {
  ...
  return (
    ...
    >
      ...
      <button data-aos="zoom-in" data-aos-delay="400" className="bg-purple-600 hover:bg-yellow-500 text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-8">VIEW MORE</button>
    </div>
  );
};
